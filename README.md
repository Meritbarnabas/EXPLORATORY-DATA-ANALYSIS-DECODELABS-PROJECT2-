...
2. Outlier Detection: Using the Interquartile Range (IQR) method, 8 high-value outlier transactions were identified in TotalPrice. Any order value extending above 3,330.41 is considered an outlier.
...
**Outlier Patterns:**
High-value transaction outliers are predominantly tied to premium product selections purchased at maximum quantities.
